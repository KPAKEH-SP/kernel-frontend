...
var require_webstomp = __commonJS({
  "node_modules/webstomp-client/dist/webstomp.js"(exports, module) {
    (function(global, factory) {
      ...
      var Frame = function() {
        function Frame2(command) {
          var headers = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var body = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "";
          classCallCheck(this, Frame2);
        ...
        createClass(Frame2, [{
          ...
          value: function unmarshall(datas) {
            var frames = datas.split(new RegExp(BYTES.NULL + BYTES.LF + "*")), firstFrames = frames.slice(0, -1), lastFrame = frames.slice(-1)[0], r = {
              frames: firstFrames.map(function(f) {
                return Frame2.unmarshallSingle(f);
              }),
              partial: ""
            };
            if (lastFrame === BYTES.LF || lastFrame.search(RegExp(BYTES.NULL + BYTES.LF + "*$")) !== -1) {
              r.frames.push(Frame2.unmarshallSingle(lastFrame));
            } else {
              r.partial = lastFrame;
            }
            return r;
          ...
          value: function marshall(command, headers, body) {
            var frame = new Frame2(command, headers, body);
      ...
      var Client = function() {
        function Client2(ws) {
          ...
          classCallCheck(this, Client2);
          var _options$binary = options.binary, binary = _options$binary === void 0 ? false : _options$binary, _options$heartbeat = options.heartbeat, heartbeat = _options$heartbeat === void 0 ? { outgoing: 1e4, incoming: 1e4 } : _options$heartbeat, _options$debug = options.debug, debug = _options$debug === void 0 ? true : _options$debug, _options$protocols = options.protocols, protocols = _options$protocols === void 0 ? [] : _options$protocols;
          this.ws = ws;
        ...
        createClass(Client2, [{
          ...
          value: function connect() {
            ...
            this.ws.onclose = function(event) {
              _this.debug("Whoops! Lost connection to " + _this.ws.url + ":", { event });
              _this._cleanUp();
          ...
          value: function send(destination) {
            var body = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
          ...
          value: function begin() {
            var transaction = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "tx-" + createId();
...
export default require_webstomp();
//# sourceMappingURL=webstomp-client.js.map
